...
export function Hero() {
  return (
    <section className="min-h-screen flex flex-col items-center justify-center px-6 py-20 bg-sunburst relative overflow-hidden">
      ...
      <motion.h1
        className="text-2xl text-gold font-display tracking-art-deco-wide mb-2"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      <motion.span
        className="text-sm text-gold/60 font-display tracking-wider mb-10"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      >
        <Button variant="solid" href={APP_CONFIG.downloadUrl}>
          <Download className="w-5 h-5" />
          Download for Mac
        </Button>
        <Button variant="primary" href={APP_CONFIG.githubUrl} target="_blank">
